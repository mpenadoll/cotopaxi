...
const float Ki = 0.0; // integral gain [V / (K*s)]
...
float tempSetpoint = (190 + 459.67) * 5.0/9.0; // temp for dipping [F to K]
...
const int voltMax = 120 * 1.0; // artificial max on the volts [V]
